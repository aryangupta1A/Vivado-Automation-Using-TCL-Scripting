...
HD_PWD='/home/vlsidesign8/IC_Design/Automation/test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_full_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_full_adder.tcl
